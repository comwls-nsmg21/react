...
class BankList extends Component {
	...
	constructor(props) {
		super(props);
		this.api = {
			'apps.keys': 'http://rsc9-api.koreasouth.cloudapp.azure.com/api/targets?category=bank&type=personal',
						...
						<div className="card">
							...
							<div className="card-body">
								<div className="banks-utility-wrap cf" style={{'width':'100%','position': 'relative'}}>
									<BankListFilter onChange={this.handleFilter} reqApps={this.state.reqApps} resApps={this.appsKey.apps} page={this.props.location} />
                                </div>
