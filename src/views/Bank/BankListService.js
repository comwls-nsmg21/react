...
class BankListService extends Component {
	...
	constructor(props) {
		super(props);
		this.api = {
			'apps.keys': 'http://rsc9-api.koreasouth.cloudapp.azure.com/api/targets?category=bank&type=service',
			'apps.getLists': 'http://rsc9-api.koreasouth.cloudapp.azure.com/api/apps/stats?category=bank&type=service'
		};
		this.appsKey = {
			targets:[]
		};
