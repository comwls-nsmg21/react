...
import TrendItemKeyword from "./TrendItemKeyword";
import LineChart from "../Common/Chart/LineChart"

class TrendAppsPrdKeyword extends Component {
    constructor(props) {
        super(props);
        ...
        this.api = {
            ...
            'trend': 'http://rsc9-api.koreasouth.cloudapp.azure.com/api/trends/keywords?category=bank&type=product',
        };
        this.appsKey = {
			apps:[]
		};
    ...
    render() {
        ...
        const item = trends.map((val,idx) => {
            return <TrendItemKeyword key={idx} item={val} idx={idx + 1} />
        });
        ...
        const contentItems = (
            <table className="table table-hover trend-table mb-0 table-bordered">
                ...
                <th className="text-center align-middle" rowSpan={2}>순위</th>
                    ...
                    <th className="text-center align-middle" rowSpan={2}>은행</th>
                    ...
                    <div className="col-md-12">
                        <div className="card">
                            <div className="card-header">
                                <div className="float-left mt-2"><i className="fa fa-building"> </i>은행상품별 검색(키워드)</div>
...
export default TrendAppsPrdKeyword;